                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
									...
									<a class="nav-link" href="/livros/novo">Novo</a></nav>
                            </div>
                            <!--
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Editar Livro</div>
                            <div class="card-body">
                                ...
                                @csrf                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
														...
														<input class="form-control" type="text"  name="nome" placeholder="Nome do livro" value="{{ $livro->nome }}" />
													</div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
														<label class="small mb-1" for="autor">Autor</label>
                                                        <input class="form-control" type="text" name="autor" placeholder="Nome do Autor" value="{{ $livro->autor }}" />
													</div>
                                                </div>
                                            </div>
                                            <div class="form-group">
												<label class="small mb-1" for="editora">Editora</label>
												<input class="form-control" type="text" name="editora" placeholder="Editora do livro" value="{{ $livro->editora }}" /></div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
													<label class="small mb-1" for="isbn">ISBN</label>
													<input class="form-control" type="text" name="isbn" placeholder="Informe seu ISBN" value="{{ $livro->isbn }}" /></div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
													<label class="small mb-1" for="idioma">Idioma</label>
													<input class="form-control" type="text" name="idioma" placeholder="Informe o idioma do livro" value="{{ $livro->idioma }}" /></div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
													<label class="small mb-1" for="paginas">Paginas</label>
													<input class="form-control" type="text" name="paginas" placeholder="Informe a quantidade de paginas do livro" value="{{ $livro->paginas }}" /></div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
													<label class="small mb-1" for="preco">Preco</label>
													<input class="form-control" type="text" name="preco" placeholder="Informe o preço do livro" value="{{ $livro->preco }}"  /></div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
													<label class="small mb-1" for="avaliacao_livro">Avaliação do livro</label>
													<input class="form-control" type="number" name="avaliacao_livro" placeholder="Avalie o Livro" value="{{ $livro->avaliacao_livro }}"  /></div>
                                                </div>
                                            </div>
