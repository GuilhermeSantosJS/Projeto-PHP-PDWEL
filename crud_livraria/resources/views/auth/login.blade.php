			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="{{ route('login.custom') }}">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input type="text" placeholder="Email" id="email" class="input100" name="email" required
							autofocus>
					...
					<div class="wrap-input100 validate-input" data-validate = "Senha é obrigatoria">
						<input type="password" placeholder="Password" id="password" class="input100" name="password" required>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
